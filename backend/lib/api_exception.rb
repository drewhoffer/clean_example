# Taken from -- https://robinseo.medium.com/rails-api-elegant-error-handling-the-centralized-way-c564dc5d1fa3
# ApiException
# This module centralizes handling of pre-defined exceptions
# For use, include ApiException::Handler on your controller
# For delegating all application errors, Simply include the handler on your ApplicationController
#
module ApiException
  # = EXCEPTIONS
